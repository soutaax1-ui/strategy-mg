...
export const reactionMap: Record<MascotEvent, ReactionConfig> = {
  gameStart:         { expression: 'joy',      reaction: 'bigHop',   duration: 1800, showSpeech: true,  priority: 'High'   },
  ...
  bidSuccess:        { expression: 'joy',      reaction: 'bigHop',   duration: 1800, showSpeech: true,  priority: 'High'   },
  bidFail:           { expression: 'sadness',  reaction: 'shake',    duration: 1200, showSpeech: true,  priority: 'Medium' },
  ...
  profit:            { expression: 'joy',      reaction: 'bigHop',   duration: 1800, showSpeech: true,  priority: 'High'   },
  loss:              { expression: 'sadness',  reaction: 'sink',     duration: 1800, showSpeech: true,  priority: 'High'   },
  cashCrisis:        { expression: 'anger',    reaction: 'shake',    duration: 1500, showSpeech: true,  priority: 'High'   },
  ...
  riskCardGood:      { expression: 'joy',      reaction: 'hop',      duration: 1200, showSpeech: true,  priority: 'Medium' },
  riskCardBad:       { expression: 'sadness',  reaction: 'shake',    duration: 1200, showSpeech: true,  priority: 'Medium' },
